        ...
        {#if !mobile}
            <div class="column" style="--row-gutter:24px">
                {#each col[0] as sketch, index}
                    <div class="img-container { index === 0 ? 
                        monetized ? 
                        "featured" : 
                        "hidden" 
                        : null
...
{#if !hasMore}
    <footer class="flex-container-centered">
        <div>
            <p>
            This is web-monetized through <a href="https://coil.com/">coil</a>. 
            If you are subscribed, you will see the 3 most recent sketches.
            <br>
            <span class="emoji">🤓</span>
            </p>
            <p>
                <small>
                    &copy; Copyright {new Date().getUTCFullYear()}, xanderjakeq. All rights reserved.
                </small>
            </p>
        <div>
    </footer>
